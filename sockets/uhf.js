      ...
      try {
        ...
        if (isLowStock && !item.lowStockAlertSent) {
          ...
          uhfNamespace.to(companyRoom).emit("low-stock-alert", {
            ...
            location: {
              warehouseName: reader.location.warehouseId
                ? reader.location.warehouseId.name
                : "Unknown",
              zoneName: reader.location.zoneId
                ? reader.location.zoneId.name
                : "Unknown",
              shelfName: reader.location.shelfId
                ? reader.location.shelfId.name
                : "Unknown",
              binName: reader.location.binId
                ? reader.location.binId.name
                : "Unknown",
            },
            timestamp: Date.now(),
          });
